            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p class="mt-4 mb-4 job-search-sub-text">At Elevation Church we have a mandate to provide 1000+ jobs by the end of {{date('Y')}}.<br /> please take this opportunity seriously by advancing your career to the next level<br />God is at work already through testmonies</p>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4 class="mb-3">Specialized Jobs</h4>
                    </div>
                </div>
