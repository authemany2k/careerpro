...
@section('content')
    <div class="row">
        ...
        <a href="{{ url('dashboard/employer/applicants-export') }}" target="_blank"><button type="button" class="btn btn-success">
            <span class="btn-label"><i class="fa fa-download"></i></span>To Excel</button></a>
